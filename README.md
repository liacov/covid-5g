...
### OPTION 1
- Command: ```python scripts/download.py --from_date "2020-07-01" --add_days 2 --out_path "data/tweets_test_2.jsonl" --label "ClimateDev" --product "30day" --keywords "#COVID" "COVID19"```
- Output:
```Sampling tweets from 2020-07-01 to 2020-07-03
...
### OPTION 2
- Command: ```python scripts/download.py --from_date "2020-07-01" --add_days 2 --out_path "data/tweets_test_2.jsonl" --label "ClimateDev" --product "30day" --keywords "#COVID" "COVID19" --add_5g```
- Output:
```Sampling tweets from 2020-07-01 to 2020-07-03
